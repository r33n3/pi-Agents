...
#attachment-list{display:flex;flex-wrap:wrap;gap:7px;margin:0 8px 7px}#attachment-list:empty{display:none}.attachment-chip{display:flex;align-items:center;gap:6px;max-width:250px;padding:6px 8px;border:1px solid var(--line);border-radius:9px;background:var(--surface2);font-size:11px}.attachment-chip a{min-width:0;overflow:hidden;color:var(--text);text-overflow:ellipsis;white-space:nowrap}.attachment-chip span{color:var(--muted);white-space:nowrap}.attachment-chip button,#attachment-button{border:0;background:transparent;color:var(--muted)}.attachment-chip button:hover,#attachment-button:hover{color:var(--text)}#attachment-button{flex:0 0 42px;width:42px;height:42px;border-radius:50%;font-size:25px}.composer-drop{border-color:var(--pi)!important;background:#1b2735!important}.capability-section{margin-bottom:18px}.capability-section h3{margin:0 4px 7px;font-size:11px;text-transform:uppercase;letter-spacing:.09em;color:var(--muted)}.capability-card{padding:10px}.capability-card strong{display:flex;justify-content:space-between;gap:8px}.capability-status{color:var(--pi);font-size:10px;text-transform:uppercase}.capability-meta{margin-top:5px;color:var(--muted);font-size:10px;overflow-wrap:anywhere}
