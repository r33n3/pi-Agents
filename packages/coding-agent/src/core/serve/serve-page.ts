...
@media(max-width:1024px),(max-width:1366px) and (hover:none) and (pointer:coarse){.rail{padding-bottom:72px}.rail #open-settings{z-index:10}.delegation-panel-host>.card{max-height:min(32dvh,280px)}}
